...
config_path = '/Users/ajinkyaprabhu/BB/config.json'
...
logo_image = "/Users/ajinkyaprabhu/BB/BB_docs/Blue-badge-assessment-toolkit-main/Agilisys-Logo-Black-RGB.png"  # Replace with the actual logo image file name
...
def main():
    ...
    df = pd.read_excel('/Users/ajinkyaprabhu/BB/NSC_updated (2).xlsb',
    ...
    if extracted_texts:
        ...
        for i, extracted_text in enumerate(extracted_texts):
            ...
            for question, marks in qs_list:
                ...
                if question == 'Permanent disability or condition (expected not to improve for at least 3 years)?':
                    ...
                    {extracted_text}
                     ...
                     Example 1: Description of conditions:
                    ...
                    Example 1: 
                    Able to walk from and to: from my home to junction Victoria Quadrant and Worthy Lane
                    Answer: Don't Know
                    ...
                    Example 4:
                    She can walk around some shopping centre such as the Crown Glass Shopping Centre to do her shopping if accompanied by a family member and transported by a vehicle.
                    Answer: >80 m
            ...
            # Display the table of questions, answers, and marks for the first 5 questions
                ...
                # rejected_sections = remaining_result_df[remaining_result_df['Score'] & result_df['Score'] == 0]
